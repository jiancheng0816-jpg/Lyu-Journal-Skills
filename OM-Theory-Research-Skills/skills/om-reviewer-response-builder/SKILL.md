...
description: Build rigorous, traceable revision strategies and point-by-point responses for analytical OM and quantitative-management papers. Implicitly trigger for 审稿意见、回复审稿人、response letter、rebuttal、revision memo、R&R、第二轮/多轮审稿、point-by-point response, reviewer comments, or requests to reconcile promised revisions with the manuscript. Do not trigger for ordinary paper critique, model audit without reviewer comments, literature review without an R&R context, journal selection, or general manuscript rewriting.
---
